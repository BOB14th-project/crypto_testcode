...
public class JavaNativeSSL {
    ...
    static {
        ...
        try {
            ...
            System.err.println("gcc -shared -fPIC -I$JAVA_HOME/include -I$JAVA_HOME/include/linux java_jni_bridge_symmetric_java_native_s_s_l.c -lssl -lcrypto -o libjavanativessl.so");
        }
    }
